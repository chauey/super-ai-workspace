...
@Component({
  ...
  template: `<div class="app-container"><div class="hero-section"><h1>Family Tree</h1><p>Genealogy and family history management</p></div><div class="coming-soon"><mat-icon>construction</mat-icon><h2>Coming Soon</h2></div></div>`,
