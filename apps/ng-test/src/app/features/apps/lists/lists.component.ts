...
@Component({
  ...
  template: `<div class="app-container"><div class="hero-section"><h1>Lists</h1><p>Personal and shared list management</p></div><div class="coming-soon"><mat-icon>construction</mat-icon><h2>Coming Soon</h2></div></div>`,
