...
@Component({
  ...
  template: `<div class="app-container"><div class="hero-section"><h1>Chat</h1><p>Real-time messaging and communication</p></div><div class="coming-soon"><mat-icon>construction</mat-icon><h2>Coming Soon</h2></div></div>`,
